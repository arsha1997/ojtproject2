        ...
        <div class="top container-fluid">
            <div class="row">
                ...
                <div class="col-7 text-warning">
                    ...
                    <h4 class="h3">ACADEMIC CALENDAR</h4>
                </div>
...
<form  action="<?php echo base_url()?>main/academiclogin" method="post" class="border  border-2 border-light p-5 rounded-bottom rounded bg-dark">
