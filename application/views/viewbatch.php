...
<div class="mt-5">
	...
	<table class="table table-striped table-bordered table-hover table-info mt-5">
		<tr><h3 class=" text-dark text-center">BATCH VIEW</h3></tr>
		<tr>
			<td>Batch name</td>
			<td>Start date</td>
			<td>End date</td>
			...
			if($n->num_rows()>0)
			{
				foreach($n->result() as $row)
				{
					...
					<tr>
						...
						<td><?php echo $row->totalhr;?></td>
						<td><a href="<?php echo base_url()?>main/deletebatch/<?php echo $row->id;?>">Delete</a></td>
						<td><a href="<?php echo base_url()?>main/batchupdateview/<?php echo $row->id;?>">Update</a></td>
					</tr>
